...
(function( $ ) {
	...
	function Scrollbar(root, options) {
		...
		// doms hack to avoid putting all this html in my markup. 	
		var originalContent = root.html();

		root.children().wrapAll('<div class="overview"/>');
		root.children().wrapAll('<div class="viewport"/>');
		var track = '<div class="scrollbar"><div class="track"><div class="thumb"><div class="end"></div></div></div></div>';
